...
},{"global/document":4,"hyperx":7,"on-load":25}],2:[function(require,module,exports){
...
},{"./normalize":10,"./parser":11,"./skeleton":12,"./types":13}],10:[function(require,module,exports){
"use strict";
var __spreadArrays = (this && this.__spreadArrays) || function () {
    for (var s = 0, i = 0, il = arguments.length; i < il; i++) s += arguments[i].length;
    for (var r = Array(s), k = 0, i = 0; i < il; i++)
...
},{"./parser":11,"./types":13}],11:[function(require,module,exports){
"use strict";
...
},{"./formatters":16,"intl-format-cache":8,"intl-messageformat-parser":9}],15:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
},{"./error":15,"intl-messageformat-parser":9}],17:[function(require,module,exports){
"use strict";
/*
Copyright (c) 2014, Yahoo! Inc. All rights reserved.
Copyrights licensed under the New BSD License.
...
},{"./core":14,"./error":15,"./formatters":16}],18:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/*
Copyright (c) 2014, Yahoo! Inc. All rights reserved.
...
},{"assert":24,"global/document":4,"global/window":5}],26:[function(require,module,exports){
(function (process){
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
	typeof define === 'function' && define.amd ? define(factory) :
...
},{"./update-events.js":29,"bel":1,"morphdom":23}],29:[function(require,module,exports){
module.exports = [
...
function _templateObject() {
  var data = _taggedTemplateLiteral(["<div class=\"container landing\">\n                          <div class=\"row\">\n                              <div class=\"col s10 push-s1\">\n                                  <div class=\"row\">\n                                      <div class=\"col m5 hide-on-small-only \">\n                                          <img src=\"iphone.png\" class=\"iphone\">\n                                      </div>\n                                        ", "\n                                      </div>\n                                  </div>\n                              </div>\n                          </div>\n                        </div>"]);
...
module.exports = function pictureCard(pic) {
  ...
  function render(picture) {
    return yo(_templateObject(), picture.liked ? 'liked' : '', picture.url, picture.user.username, picture.user.avatar, picture.user.username, translate.date.format(picture.createdAt), like.bind(null, true), like.bind(null, false), translate.messages('likes', {
      likes: picture.likes
    }));
  }
